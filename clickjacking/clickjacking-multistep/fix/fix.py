#!/usr/bin/env python3
"""Multistep clickjacking fix verifier — same header checks as basic."""
...
def verify(url, timeout=10):
    ...
    if xfo in ("DENY", "SAMEORIGIN"):
        ...
        checks["xfo"]["detail"] = f"X-Frame-Options missing (found: '{xfo or 'none'}')"
...
def main():
    print("\n[+] Multistep Clickjacking — Fix Verifier\n")
